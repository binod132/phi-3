...
job = aiplatform.CustomJob.from_local_script(
    ...
    script_path="gpu-test.py",  # The script you already embedded in the Docker image
    container_uri="us-docker.pkg.dev/brave-smile-424210-m0/train/phi-3:main",  # Your Docker image
    replica_count=1,  # Number of machines to run the job on
    machine_type="n1-standard-4",  # The machine type
